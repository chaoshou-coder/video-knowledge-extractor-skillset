...
独立可运行的 skills-first CLI 工具：从视频字幕（SRT/TXT）提取结构化知识并导出教材内容。

[![CI](https://github.com/chaoshou-coder/video-knowledge-extractor-skillset/actions/workflows/ci.yml/badge.svg)](https://github.com/chaoshou-coder/video-knowledge-extractor-skillset/actions)
...
- 仓库定位：**独立项目**（与 `video-knowledge-extractor` 分仓开发）
